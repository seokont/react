    ...
    return (
        <div>
            <form onSubmit={props.handleSubmit} style={{marginTop: '20px'}}>
                <table className={style.table_new_tournament}>
                    <tbody>
                    <tr>
                        <th colSpan="2"><h2>Create Tournament</h2></th>
                    </tr>
                    <tr>
                        <td colSpan="2">&nbsp;</td>
                    </tr>
                    ...
                    {props.mixed === 'Mixed' ? <tr>
                        ...
                        <td>
                            <Bounce><Field type="checkbox" component={'input'} className={style.form_input} name={"on1"}/>Limit
                                Hold'em<br></br>
                                ...
                                <Field type="checkbox" component={'input'} className={style.form_input} name={"on18"}/>Limit Stud
                                Hi-Lo<br></br></Bounce>
                        </td>
                    </tr> : ''}
                    <tr>
                    ...
                    <tr>
                        <td>Start now:</td>
                        <td><Field className="stretch" type="text" name={"StartMin"} placeholder="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Maximum runs:</td>
                        <td><Field className="stretch" type="text" name={"MaxRuns"} placeholder="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Buy-in:</td>
                        <td><Field className="stretch" type="text" name={"BuyIn"} placeholder="1500" component={'input'} className={style.form_input}
                                   title="Select the buy-in for this tournament. The default value is 1500. The buy-in does not include the entry fee."/>
                        </td>
                    </tr>
                    <tr>
                        <td>Bounty:</td>
                        <td><Field className="stretch" type="text" name={"Bounty"} placeholder="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Entry Fee:</td>
                        <td><Field className="stretch" type="text" name={"EntryFee"} placeholder="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Ticket:</td>
                        <td><Field className="stretch" type="text" name={"Ticket"} placeholder="" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Rebuy fee:</td>
                        <td><Field className="stretch" type="text" name={"RebuyFee"} placeholder="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><Field className="stretch" type="text" name={"PropChop"} placeholder="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Note:</td>
                        <td><Field className="stretch" type="text" name={"Note"} placeholder="" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td colSpan="2" height="60" align="center">
                            ...
                            {props.adturnamentsnew.Error !== '' ?
                                <h3 style={{color: 'red'}}>{props.adturnamentsnew.Error === '' ?
...
const AddTournaments = (props) => {
    ...
    return <div>
        <ContactFormTournaments mixed={props.adturnamentsnew.Mixed} adturnamentsnew={props.adturnamentsnew}
                                mixedThunk={props.mixedThunk} onSubmit={onSubmit}/>
    </div>
}
