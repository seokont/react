...
import {NumberPageAction} from "../../Reducer/getplayers-reducer";
...
export default function Getplayers(props) {
    ...
    const [rowsPerPage, setRowsPerPage] = React.useState(props.getNumberPage);
    ...
    const handleChangeRowsPerPageNew = (ss) => {
        setRowsPerPage(parseInt(ss, 20));
        setPage(0);
    };
    useEffect(() => {
        handleChangeRowsPerPageNew(props.getNumberPage);
    }, [props.getNumberPage]);
            ...
            {props.resultgetplayers === "" ? (
                ...
                <Paper className={classes.paper}>
                    ...
                    <TableContainer className={style.tableFixHeader}>
                        ...
                        >
                            <EnhancedTableHead  stickyHeader={true} aria-label="sticky table"
                                classes={classes}
                                            ...
                                            <>
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="right"
                                                               style={{fontWeight: "bold", color: 'rgb(98, 216, 38)'}}>
                                                        <Diamond/> {row.Balance}
                                                    </TableCell>
            ...
            <Autocomplete
                ...
                renderInput={(params) => (
                    <CssTextField
                        ...
                        onClick={() => props.NumberPageAction(100)}
                        {...params}
                        label="Search Player"
                        margin="normal"
                        variant="outlined"
