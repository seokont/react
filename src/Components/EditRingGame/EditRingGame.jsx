        ...
        <div>
            <form onSubmit={props.handleSubmit} style={{marginTop:'20px'}}>
                <table className={style.table_edit_table}>
                    ...
                    <tr>
                        <td>New Name:</td>
                        <td><Field type="text" name={"NewGameID"} component={'input'} className={style.form_input} placeholder='Enter a new name'
                    ...
                    <tr>
                        <td>Mixed hands:</td>
                        <td><Field type="text" name={"MixedHands"} component={'input'} className={style.form_input} placeholder="0"
                    ...
                    <tr>
                        <td>Password:</td>
                        <td><Field type="text" name={"Password"} value="" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><Field type="text" name={"PermPlay"} value="" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><Field type="text" name={"PermObserve"} value="" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><Field type="text" name={"PermPlayerChat"} value="" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><Field type="text" name={"PermObserverChat"} value="" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><select name={"SuspendChatAllIn"} component={'select'} className={style.form_select} required
                    ...
                    <tr>
                        <td>Seats:</td>
                        <td><Field type="text" name={"Seats"} placeholder="9" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><Field type="text" name={"BuyInMax"} component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><Field type="text" name={"BuyInDef"} value="1200" component={'input'} className={style.form_input}
                                   placeholder={props.EditMessag.Object.BuyInDef}
                                   title="Select the default buy-in for this table. The default value is 1200."/></td>
                    </tr>
                    <tr>
                        <td>Cap limit:</td>
                        <td><Field type="text" name={"CapLimit"} value="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Rake percent:</td>
                        <td><Field type="text" name={"RakePercent"} value="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Rake cap:</td>
                        <td><Field type="text" name={"RakeCap"} value="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Turn clock:</td>
                        <td><Field type="text" name={"TurnClock"} value="30" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Turn warning:</td>
                        <td><Field type="text" name={"TurnWarning"} value="10" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Time bank:</td>
                        <td><Field type="text" name="BankClock" value="60" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><Field type="text" name={"BankReset"} value="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Small blind:</td>
                        <td><Field type="text" name={"SmallBlind"} value="10" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Big blind:</td>
                        <td><Field type="text" name={"BigBlind"} value="20" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Small bet:</td>
                        <td><Field type="text" name={"SmallBet"} value="20" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Big bet:</td>
                        <td><Field type="text" name={"BigBet"} value="40" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        <td>Bring-in:</td>
                        <td><Field type="text" name={"BringIn"} value="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><Field type="text" name={"RatholeMinutes"} value="0" component={'input'} className={style.form_input}
                    ...
                    <tr>
                        ...
                        <td><Field type="text" name={"SitoutMinutes"} value="10" component={'input'} className={style.form_input}
